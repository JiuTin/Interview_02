...
namespace MagicaReductionMesh
{
    ...
    public class MeshData : ReductionMeshAccess
    {
        ...
        /// <returns></returns>
        public int AddMesh(Transform root, List<Vector3> posList, List<Vector3> norList = null, List<Vector4> tanList = null, List<Vector2> uvList = null)
        {
        ...
        /// <summary>
        /// 通するエッジをもつ２つのトライアングルが開いているか判定する
        /// </summary>
